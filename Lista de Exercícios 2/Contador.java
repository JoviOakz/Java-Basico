public class Contador {
    ...
    // Exercicio 2
    // Faça um programa (F.U.P) que instancie a classe contatodor do exercício anterior, criando
    // um objeto novoContador do tipo Contador. Depois o programa deve realizar as seguintes ações:
